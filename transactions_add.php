    ...
    <div class="wrapper">
        ...
        <div class="main-panel">
            ...
            if (isset($_POST['submit'])) {
                ...
                $sql = "INSERT INTO transaction(documentcode, action, remarks, employee_id, office_id) 
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="POST" action="<?php $_SERVER['PHP_SELF']; ?>">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3 px-1">
                                                <div class="form-group">
                                                    <label>Action</label>
                                                    <select class="full-control" name="action">
                                                        <option>IN</option>
                                                        <option>OUT</option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <?php
                                                    ...
                                                    while ($row = mysqli_fetch_array($result)){
                                                        echo "<option value" . $row['id'] . ">" . $row['Employee'];
                                                    }
                                                ?>
                                    ...
                                    <button type="submit" name="submit" value="submit" class="btn btn-info btn-fill pull-right"></button>
